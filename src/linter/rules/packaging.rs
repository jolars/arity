...
mod description_empty_person;
mod description_encoding;
mod description_malformed_maintainer;
mod description_malformed_name;
mod description_malformed_version;
mod description_missing_field;
mod description_package_in_multiple_fields;
mod description_text_format;
mod description_unknown_field;
...
pub use description_empty_person::DescriptionEmptyPerson;
pub use description_encoding::DescriptionEncoding;
...
pub use description_malformed_version::DescriptionMalformedVersion;
...
pub use description_text_format::DescriptionTextFormat;
pub use description_unknown_field::DescriptionUnknownField;
