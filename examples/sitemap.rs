//! Post-build sitemap generator for the arity docs.
//!
...
//! publishable crate, matching `examples/docgen.rs`: `examples/` is outside the
//! Cargo `include` whitelist, so this never ships to crates.io.
