...
```sh
# with direnv, the environment loads automatically via .envrc
direnv allow
...
- Wrap code in backticks in commit messages, and avoid fancy Unicode
  characters.
...
[issue tracker](https://github.com/jolars/arity/issues). For a bug, a minimal R
snippet that reproduces the problem is the most helpful thing you can include.
