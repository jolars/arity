...
## [0.24.0](https://github.com/jolars/arity/compare/arity-code-v0.23.0...arity-code-v0.24.0) (2026-09-15)

### Dependencies
- updated arity to v0.24.0
...
### Dependencies
- updated arity to v0.8.0

## [0.7.0](https://github.com/jolars/arity/compare/arity-code-v0.6.0...arity-code-v0.7.0) (2026-06-24)

### Dependencies
- updated arity to v0.7.0
...
- Initial release: starts the `arity` language server (`arity lsp`) for R files,
  with bundled-binary, PATH, and GitHub-release download strategies.
