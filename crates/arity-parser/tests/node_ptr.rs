...
use arity_parser::ast::{AssignmentExpr, AstNode, CallExpr, FunctionExpr};
use arity_parser::parser::{Edit, map_range_through_edit, parse};
use arity_parser::syntax::{NodePtr, SyntaxKind, SyntaxNode};
...
fn first<N: AstNode<Language = arity_parser::syntax::RLanguage>>(root: &SyntaxNode) -> N {
